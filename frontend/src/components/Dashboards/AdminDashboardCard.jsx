      ...
      <tr>
        ...
        <td><button onClick={() => openModal()} className='btn bg-primary text-white'>
          ...
          >
            ...
            />
            <path
              d="M7,9.27A5.77,5.77,0,0,1,7.08,8,6,6,0,0,1,19,9a5.94,5.94,0,0,1-1.34,3.77,1,1,0,0,0,.28,1.45A7,7,0,0,1,21,20a1,1,0,0,1-1,1H15"
              stroke="#005c6a"
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth="2"
        ...
        <td><button onClick={() => deleteUser(user.id)} className='btn bg-info text-white'>
          <svg
            ...
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
            className="w-6 h-6 icon line-color"
          >
            <g id="SVGRepo_iconCarrier">
              ...
              />
              <path
                d="M10,21H20a1,1,0,0,0,1-1,7,7,0,0,0-3.06-5.78,1,1,0,0,1-.28-1.45A5.94,5.94,0,0,0,19,9,6,6,0,0,0,7.08,8a5.9,5.9,0,0,0,.27,3"
                stroke="#50c6c9"
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
