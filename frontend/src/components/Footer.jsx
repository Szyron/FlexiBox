        ...
        <div>
            ...
            <footer className="footer bg-base-100 text-base-content p-10">
                ...
                <nav>
                    ...
                    <a><button className="text-info" onClick={() => openTermInfo()}>Felhasználási feltételek</button></a>
                    <a><button className="text-info" onClick={() => openPolicyInfo()}>Adatvédelmi irányelvek</button></a>
                </nav>
            </footer>
            <footer className="footer bg-base-100 text-base-content border-t border-primary px-10 py-4">
                ...
                <nav className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <a>
                            <svg fill="#50c6c9" width="32px" height="32px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M21.95 5.005l-3.306-.004c-3.206 0-5.277 2.124-5.277 5.415v2.495H10.05v4.515h3.317l-.004 9.575h4.641l.004-9.575h3.806l-.003-4.514h-3.803v-2.117c0-1.018.241-1.533 1.566-1.533l2.366-.001.01-4.256z"></path></g></svg>
                        </a>
                    </div>
                </nav>
            </footer>
